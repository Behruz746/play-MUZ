...
function MusicPlayer() {
  ...
  return (
    ...
    >
      <div
        className={`max-w-[1550px] w-full flex items-center  mdd:gap-[10px] mdd:justify-between transition-none ${
      ...
      >
        ...
        >
          ...
          {!playerToggle && (
            <button
              className={`hidden p-[15px] ml-[auto] rotate-[270deg] mdd:block`}
              onClick={bigPlayer}
            >
              <ArrowIcon2 />
            </button>
        ...
        <div className="w-full flex items-center justify-between gap-[50px] mdd:gap-[15px] mdd:flex-col-reverse ">
          ...
          >
            ...
            {playerToggle && (
              <button
                className={`hidden p-[15px] rotate-[270deg] mdd:block`}
                onClick={bigPlayer}
              >
                <img
                  width="20px"
